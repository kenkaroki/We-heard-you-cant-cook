...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<section class="signup">`);
    {
      $$renderer2.push("<!--[-->");
      ...
      $$renderer2.push(`<!--]--></button></div> <button type="submit">Sign Up</button></form></div> <a${attr("href", `${stringify(base)}/signup`)} class="login_switch">Already have an account? Login</a>`);
    }
...
//# sourceMappingURL=_page.svelte-CmQdr6wZ.js.map
